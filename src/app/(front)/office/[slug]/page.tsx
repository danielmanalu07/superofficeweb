...
import SalesContact from "@/features/offices/components/SalesContactCard";
...
export default async function OfficeSpaceDetailsPage({ params }: Props) {
  const { slug } = await params;

  const office = officeSpace.find((item) => item.slug === slug);
          ...
          <div className="overflow-hidden w-full h-[280px]">
            ...
            >
              <iframe
                ...
                src={`https://www.google.com/maps/embed/v1/place?q=${office.location},&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8`}
              />
            </div>
            <a
